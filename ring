...
Title.Text = "Super Ring Parts v3.2"
Title.TextColor3 = Color3.fromRGB(101, 67, 33) -- Dark brown
Title.BackgroundColor3 = Color3.fromRGB(240, 0, 0) -- Lighter brown
...
RadiusDisplay.BackgroundColor3 = Color3.fromRGB(200, 0, 0) -- Tan
...
MinimizeButton.Text = "-"
MinimizeButton.BackgroundColor3 = Color3.fromRGB(200, 0, 0) -- Saddle brown
...
StarterGui:SetCore("SendNotification", {
    Title = "Enjoy da Super Ring lol ",
    Text = "Cracked By @Azmac102289p Bitches",
    Icon = content,
    Duration = 5
})
